 ...
 * @author user
 */
public class AdminOptionsUI extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton2.setBounds(110, 180, 170, 40);
        ...
        jButton3.setBounds(110, 110, 170, 40);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        AddRestaurantUI add = new AddRestaurantUI();
        add.setVisible(true);
        this.dispose();
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        DeleteRestaurant delete = new DeleteRestaurant();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AdminOptionsUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
